tailwind.config = {
    theme: {
        ...
        extend: {
            backgroundImage: {
                "home": "url('./Assets/bg.png')" // Verifique se o caminho da pasta está correto
            }
        }
    }
}
...
checkoutBtn.addEventListener('click', function () {
    ...
    if (cart.length === 0) {
        addressWarn.innerHTML = "Seu carrinho está vazio!";
    ...
    *Total: R$ ${cartTotal.textContent}*`
    ...
    const message = encodeURIComponent(cartItemsMessage);
    const phone = "5519987818604"
